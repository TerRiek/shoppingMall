...
public class AdminController {
	...
	public String registMerchandise(Merchandise merchandise, @RequestParam("file") MultipartFile file,
	...
	public String delete(@RequestParam("mno") Long mno, HttpSession session) {
		...
		purchaseRepository.deleteBySno(stockRepository.findByMno(mno).getSno());
	...
	public String orderStock(@RequestParam("mno") Long mno,
			@RequestParam(value = "amount", required = false) Long amount, HttpSession session, Model model)
			throws IOException {
